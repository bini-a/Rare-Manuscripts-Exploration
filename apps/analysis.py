...
def app():
    ...
    st.image("data/img/wdcloud-full.png")
    ...
    with col1:
        # plot_wd(1700,1800)
        st.image("data/img/wdcld-1.png")
    with col2:
        # plot_wd(1800,1900)
        st.image("data/img/wdcld-2.png")
    with col3:      
        # plot_wd(1861,1865)
        st.image("data/img/wdcld-3.png",)
    ...
    with e:
        ...
        st.image("data/img/europe.png")
    with asia_c:
        # fig = plt.figure()
        # plot(asia, 1)
        # fig.savefig("asia.png")
        st.image("data/img/asia.png")
    with n_a:
        # fig = plt.figure()
        # plot(north_america, 2)
        # fig.savefig("north_america.png")
        st.image("data/img/north_america.png")
    with s_a:
        # fig = plt.figure()
        # plot(south_america, 3)
        # fig.savefig("south_america.png")
        st.image("data/img/south_america.png")
    with a:
        # fig = plt.figure()
        # plot(asia, 4)
        # fig.savefig("africa.png")
        st.image("data/img/africa.png")
    with o:
        # fig = plt.figure()
        # plot(asia, 5)
        # fig.savefig("oceania.png")
        st.image("data/img/oceania.png")
