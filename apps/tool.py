...
def app():
    ...
    def dataset_selector():
        dataset_container = st.sidebar.beta_expander("""Explore Collections Related to Duke's History""",False)
        choice = ["Duke University Presidents",
            "Duke University Early Names"]
        with dataset_container:
    ...
    second_exp = st.beta_expander("Duke History",False)
    with second_exp:
