...
#             wordcloud = WordCloud(color_func = cfunc, stopwords=stop_words,background_color="white", width=3000, height=2000, max_words=50,collocations=True,prefer_horizontal=1).generate(filtered_sentence())
